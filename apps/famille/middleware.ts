...
export async function middleware(req: NextRequest) {
  ...
  if (pathname === "/connexion" || pathname === "/decouvrir" || pathname.startsWith("/api/auth") || pathname.startsWith("/api/passkey") || pathname.startsWith("/api/cron")) return NextResponse.next();
