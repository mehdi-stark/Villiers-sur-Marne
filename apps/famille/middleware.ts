...
export async function middleware(req: NextRequest) {
  ...
  if (pathname === "/api/sante" || pathname === "/connexion" || pathname.startsWith("/decouvrir") || pathname.startsWith("/api/auth") || pathname === "/presentation" || pathname.startsWith("/api/passkey") || pathname.startsWith("/api/cron")) return NextResponse.next();
