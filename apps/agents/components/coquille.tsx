    ...
    <div className="coquille">
      <header className="entete">
        <div className="entete-inner">
              ...
              <Dialog.Portal>
                ...
                <Dialog.Content className="tiroir" aria-describedby={undefined}>
                  ...
                  <div className="tiroir-pied">
                    ...
                    <p className="tiny">Poste : Espace Accueil et Facturation — {commune.telephone}</p>
          ...
          <Link href="/" className="marque" aria-label="Back-office agents — accueil"><span className="marque-logo" aria-hidden>{commune.initiale}</span><span>Agents <small>{commune.courte}</small></span></Link>
