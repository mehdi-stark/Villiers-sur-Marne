  ...
  return (
    <div className="connexion" style={{ minHeight: "calc(100dvh - 140px)", display: "grid", placeItems: "center" }}>
      ...
      >
        ...
        <h1>Back-office agents</h1>
        <p className="petit t-2">La file du jour, les familles, les activités — accès réservé aux agents.</p>
        ...
        {etape === "email" ? (
          <>
            ...
            <p className="mini t-3">Un code à 6 chiffres, valable 10 minutes. Accès réservé aux adresses autorisées de la collectivité.</p>
          </>
        ) : (
          <>
