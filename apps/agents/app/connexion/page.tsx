  ...
  return (
    <div className="connexion">
      ...
      >
        ...
        <p className="muted">La file du jour, les familles, les activités — accès réservé aux agents.</p>
        {etape === "email" ? (
          <>
            ...
            <p className="tiny">Un code à 6 chiffres, valable 10 minutes. Accès réservé aux adresses autorisées de la collectivité.</p>
          </>
        ) : (
          <>
