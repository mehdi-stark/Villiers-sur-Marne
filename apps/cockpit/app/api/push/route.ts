...
export async function POST(req: NextRequest) {
  ...
  await enregistrerAbonnement({ app: "cockpit", email: s.email, endpoint: b.endpoint, p256dh: b.keys.p256dh, auth: b.keys.auth, agent: req.headers.get("user-agent")?.slice(0, 160) ?? undefined });
